...
export const ListOfHeroesReal = React.forwardRef( ({el, deleteData, SeteditData, taskCheck, ...props}, ref) => {
 
  return (
    <div {...props} ref={ref} className='div__hero'>
...
({el, deleteData, SeteditData, taskCheck}) => {
